...
2. **Eliminar el "ruido visual"**: Se supone que no escribir marcas de "inicio-fin" de bloque hay menos texto que leer y por consiguiente, se supone que aumenta la "limpieza visual".
...
3. **Apostar por la limpieza visual**: Es una "limpieza" en el sentido de "ocultación visual" de algo que si existe.
