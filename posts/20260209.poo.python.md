...
Ya habíamos visto en el [post anterior](./20260206.poo.python.md) que `un Gato es un Perro`, y que todo esto es posible porque los objetos son diccionarios de atributos, y las clases son diccionarios de funciones. Esto lo habíamos comentado en el [post diccionario](./20260108.diccionario.md).
